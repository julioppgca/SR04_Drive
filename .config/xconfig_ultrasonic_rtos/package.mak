...
override PKGDIR = xconfig_ultrasonic_rtos
...
package/%.xdc.inc package/%_xconfig_ultrasonic_rtos.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_ultrasonic_rtos" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: ultrasonic_rtos.pem4f

-include package/cfg/ultrasonic_rtos_pem4f.mak
-include package/cfg/ultrasonic_rtos_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/ultrasonic_rtos_pem4f.dep
endif
ultrasonic_rtos.pem4f: package/cfg/ultrasonic_rtos_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
ultrasonic_rtos.pem4f package/cfg/ultrasonic_rtos_pem4f.c: .libraries,em4f
endif

package/cfg/ultrasonic_rtos_pem4f.c package/cfg/ultrasonic_rtos_pem4f.h package/cfg/ultrasonic_rtos_pem4f.xdl: override _PROG_NAME := ultrasonic_rtos.xem4f
package/cfg/ultrasonic_rtos_pem4f.c: package/cfg/ultrasonic_rtos_pem4f.cfg
package/cfg/ultrasonic_rtos_pem4f.xdc.inc: package/cfg/ultrasonic_rtos_pem4f.xdl
package/cfg/ultrasonic_rtos_pem4f.xdl package/cfg/ultrasonic_rtos_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/ultrasonic_rtos_pem4f.cfg
	-$(RM) package/cfg/ultrasonic_rtos_pem4f.dep
	-$(RM) package/cfg/ultrasonic_rtos_pem4f.c
	-$(RM) package/cfg/ultrasonic_rtos_pem4f.xdc.inc

clean,em4f::
	-$(RM) ultrasonic_rtos.pem4f
.executables,em4f .executables: ultrasonic_rtos.xem4f

ultrasonic_rtos.xem4f: |ultrasonic_rtos.pem4f

-include package/cfg/ultrasonic_rtos.xem4f.mak
ultrasonic_rtos.xem4f: package/cfg/ultrasonic_rtos_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/ultrasonic_rtos_pem4f.oem4f   package/cfg/ultrasonic_rtos_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
ultrasonic_rtos.xem4f: export C_DIR=
ultrasonic_rtos.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
ultrasonic_rtos.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

ultrasonic_rtos.test test,em4f test: ultrasonic_rtos.xem4f.test

ultrasonic_rtos.xem4f.test:: ultrasonic_rtos.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 ultrasonic_rtos.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.ultrasonic_rtos.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,ultrasonic_rtos.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) ultrasonic_rtos.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
ultrasonic_rtos_pem4f.oem4f,copy : package/cfg/ultrasonic_rtos_pem4f.oem4f
ultrasonic_rtos_pem4f.sem4f,copy : package/cfg/ultrasonic_rtos_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_ultrasonic_rtos
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_ultrasonic_rtos.tar.dep
endif
package/rel/xconfig_ultrasonic_rtos/xconfig_ultrasonic_rtos/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_ultrasonic_rtos/xconfig_ultrasonic_rtos/package/package.rel.xml: package/build.cfg
package/rel/xconfig_ultrasonic_rtos/xconfig_ultrasonic_rtos/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_ultrasonic_rtos/xconfig_ultrasonic_rtos/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_ultrasonic_rtos.tar: package/rel/xconfig_ultrasonic_rtos.xdc.inc package/rel/xconfig_ultrasonic_rtos/xconfig_ultrasonic_rtos/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_ultrasonic_rtos.xdc.inc,package/rel/xconfig_ultrasonic_rtos.tar.dep)


release release,xconfig_ultrasonic_rtos: all xconfig_ultrasonic_rtos.tar
clean:: .clean
	-$(RM) xconfig_ultrasonic_rtos.tar
	-$(RM) package/rel/xconfig_ultrasonic_rtos.xdc.inc
	-$(RM) package/rel/xconfig_ultrasonic_rtos.tar.dep
